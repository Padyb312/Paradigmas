 ...
 * Contiene la información personal, física y médica del astronauta,
 * con énfasis en el seguimiento de exposición a radiación.
 *
...
public class Astronauta {
    ...
    /** Género del astronauta representado por un carácter ('M' masculino, 'F' femenino). */
    private char genero;
    ...
    /** Total de radiación acumulada por el astronauta a lo largo del tiempo, expresada en mSv. */
     ...
     * @param fecha_exposicion     Fecha de exposición a radiación en formato String.
     ...
     * @param cantidad_radiacion   Dosis de radiación recibida en una exposición (mSv).
